...
extern int		Lpanel_pick(Lpanel_t *p, int button, int state,	// mouse pick function
				    int x, int y);
extern void		Lpanel_setProjection(Lpanel_t *p, int forpick);
extern void		Lpanel_setModelview(Lpanel_t *p, int eye);
...
extern int		Lpanel_addSwitch(Lpanel_t *p, const char *name, lp_obj_parm_t *obj,
					 const char *buff);
extern bool		Lpanel_addSwitchCallback(Lpanel_t *p, const char *name, lp_switch_cbf_t cbfunc,
						 int userval);
...
extern bool		Lpanel_bindLight8(Lpanel_t *p, const char *name, void *loc, int start_bit_number);
extern bool		Lpanel_bindLight16(Lpanel_t *p, const char *name, void *loc, int start_bit_number);
extern bool		Lpanel_bindLightfv(Lpanel_t *p, const char *name, void *loc);
extern bool		Lpanel_bindLight32(Lpanel_t *p, const char *name, void *loc, int start_bit_number);
extern bool		Lpanel_bindLight64(Lpanel_t *p, const char *name, void *loc, int start_bit_number);
...
extern bool		Lpanel_bindSwitch8(Lpanel_t *p, const char *name, void *loc_down, void *loc_up,
					   int start_bit_number);
extern bool		Lpanel_bindSwitch16(Lpanel_t *p, const char *name, void *loc_down, void *loc_up,
					    int start_bit_number);
extern bool		Lpanel_bindSwitch32(Lpanel_t *p, const char *name, void *loc_down, void *loc_up,
					    int start_bit_number);
extern bool		Lpanel_bindSwitch64(Lpanel_t *p, const char *name, void *loc_down, void *loc_up,
					    int start_bit_number);
...
extern void		Lpanel_exitGraphics(Lpanel_t *p);
