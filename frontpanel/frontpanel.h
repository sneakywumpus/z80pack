...
extern int	fp_bindSwitch64(const char *name, uint64_t *loc_down, uint64_t *loc_up, int bitnum);
extern int	fp_bindSwitch32(const char *name, uint32_t *loc_down, uint32_t *loc_up, int bitnum);
extern int	fp_bindSwitch16(const char *name, uint16_t *loc_down, uint16_t *loc_up, int bitnum);
...
extern int	fp_addSwitchCallback(const char *name, void (*cbfunc)(int state, int val), int userval);
